...
  return (
    <div className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border-gray-300' onClick={()=>navigate(`/viewcourse/${id}`)}>
     <img 
            src={thumbnail} 
            alt={title}  // ⬅️ Yahan sirf 'alt' attribute add kiya hai
